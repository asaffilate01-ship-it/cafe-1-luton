...
export function withProductionHeaders(request: Request, response: Response): Response {
  ...
  headers.set(
    ...
    [
      ...
      "frame-src 'self' https://pay.google.com https://www.openstreetmap.org https://www.youtube-nocookie.com https://www.youtube.com https://www.tiktok.com https://www.instagram.com https://www.facebook.com",
