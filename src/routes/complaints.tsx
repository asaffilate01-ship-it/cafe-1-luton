...
export const Route = createFileRoute("/complaints")({
  head: () => ({
    meta: [
      { title: "Complaints Policy — Café 1 St Albans" },
      { name: "description", content: "How to raise a complaint with Café 1 about an order, delivery or service, and how quickly we respond." },
  ...
  component: () => (
    ...
    >
      ...
      <Section heading="Putting it right">
        <p>Depending on the issue we will remake the item, refund the item or the order, or credit your account. Card refunds are returned to the original card via SumUp and usually appear within 3–5 working days.</p>
      </Section>
      <Section heading="Food safety and allergens">
        <p>Report suspected allergen or food safety issues immediately by phone so we can act at once. These are escalated to the café manager the same day.</p>
      </Section>
      <Section heading="If you're still unhappy">
        <p>Ask for your complaint to be escalated to the owner. You may also contact St Albans City &amp; District Council's environmental health team for food safety matters, or Citizens Advice for consumer matters.</p>
      </Section>
    </LegalPage>
  ),
});