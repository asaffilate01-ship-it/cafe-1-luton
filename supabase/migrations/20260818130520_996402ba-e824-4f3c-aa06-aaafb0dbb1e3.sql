create or replace function public.cafe1_cancel_tab_order(
  _order_id uuid,
  _reason text
)
...
revoke all on function public.cafe1_cancel_tab_order(uuid, text) from public, anon;
grant execute on function public.cafe1_cancel_tab_order(uuid, text) to authenticated, service_role;