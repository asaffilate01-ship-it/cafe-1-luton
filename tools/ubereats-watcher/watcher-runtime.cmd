...
if not defined NODE_EXE (
  echo Private Node runtime is missing. Run START-CAFE1-UBEREATS.cmd.
  exit /b 2
)

"%NODE_EXE%" "%~dp0ubereats-hub-watcher.mjs" %*
exit /b %ERRORLEVEL%
