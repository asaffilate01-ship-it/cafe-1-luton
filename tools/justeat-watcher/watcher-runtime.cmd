...
if not defined NODE_EXE (
  echo Private Node runtime is missing. Run START-CAFE1-JUSTEAT.cmd.
  exit /b 2
)

"%NODE_EXE%" "%~dp0justeat-hub-watcher.mjs" %*
exit /b %ERRORLEVEL%
